...
typedef enum {
	...
	NEMOVIEW_CATCH_STATE = (1 << 1),
	NEMOVIEW_PICK_STATE = (1 << 2),
	NEMOVIEW_KEYPAD_STATE = (1 << 3),
	NEMOVIEW_SOUND_STATE = (1 << 4),
	NEMOVIEW_LAYER_STATE = (1 << 5),
	NEMOVIEW_REGION_STATE = (1 << 6),
	NEMOVIEW_SCOPE_STATE = (1 << 7),
	NEMOVIEW_STAGE_STATE = (1 << 8),
	NEMOVIEW_OPAQUE_STATE = (1 << 9),
	NEMOVIEW_CANVAS_STATE = (1 << 10),
	NEMOVIEW_RESIZE_STATE = (1 << 11),
	NEMOVIEW_CORRECT_STATE = (1 << 12),
	NEMOVIEW_CLOSE_STATE = (1 << 13),
	NEMOVIEW_LAST_STATE
} NemoViewState;
