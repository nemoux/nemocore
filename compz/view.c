...
struct nemoview *nemoview_create(struct nemocompz *compz, struct nemocontent *content)
{
	...
	view->state = NEMOVIEW_CATCH_STATE | NEMOVIEW_PICK_STATE | NEMOVIEW_KEYPAD_STATE | NEMOVIEW_SOUND_STATE | NEMOVIEW_RESIZE_STATE | NEMOVIEW_STAGE_STATE | NEMOVIEW_CORRECT_STATE;
