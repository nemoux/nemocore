...
struct showprop *nemoshow_get_property(const char *name)
{
	static struct showprop props[] = {
		...
		{ "light",						NEMOSHOW_FLOAT_PROP,				NEMOSHOW_REDRAW_DIRTY },
		{ "matrix",						NEMOSHOW_FLOAT_PROP,				NEMOSHOW_MATRIX_DIRTY },
		{ "mode",							NEMOSHOW_STRING_PROP,				NEMOSHOW_STYLE_DIRTY },
		{ "name",							NEMOSHOW_STRING_PROP,				NEMOSHOW_NONE_DIRTY },
		{ "normal",						NEMOSHOW_FLOAT_PROP,				NEMOSHOW_SHAPE_DIRTY },
		{ "offset",						NEMOSHOW_DOUBLE_PROP,				NEMOSHOW_SHAPE_DIRTY },
		{ "path",							NEMOSHOW_STRING_PROP,				NEMOSHOW_NONE_DIRTY },
		{ "pathdash",					NEMOSHOW_DOUBLE_PROP,				NEMOSHOW_PATH_DIRTY },
		{ "pathdashcount",		NEMOSHOW_INTEGER_PROP,			NEMOSHOW_PATH_DIRTY },
		...
		{ "rz",								NEMOSHOW_DOUBLE_PROP,				NEMOSHOW_SHAPE_DIRTY },
		...
		{ "sz",								NEMOSHOW_DOUBLE_PROP,				NEMOSHOW_MATRIX_DIRTY },
		{ "t",								NEMOSHOW_DOUBLE_PROP,				NEMOSHOW_SHAPE_DIRTY },
		{ "texcoord",					NEMOSHOW_FLOAT_PROP,				NEMOSHOW_SHAPE_DIRTY },
		...
		{ "tz",								NEMOSHOW_DOUBLE_PROP,				NEMOSHOW_MATRIX_DIRTY },
		{ "uri",							NEMOSHOW_STRING_PROP,				NEMOSHOW_URI_DIRTY },
		{ "value",						NEMOSHOW_DOUBLE_PROP,				NEMOSHOW_NONE_DIRTY },
		{ "vertex",						NEMOSHOW_FLOAT_PROP,				NEMOSHOW_SHAPE_DIRTY },
