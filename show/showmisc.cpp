...
struct showprop *nemoshow_get_property(const char *name)
{
	static struct showprop props[] = {
		...
		{ "ax",								NEMOSHOW_DOUBLE_PROP,				NEMOSHOW_MATRIX_DIRTY,			NEMOSHOW_ANCHOR_STATE | NEMOSHOW_TRANSFORM_STATE },
		{ "ay",								NEMOSHOW_DOUBLE_PROP,				NEMOSHOW_MATRIX_DIRTY,			NEMOSHOW_ANCHOR_STATE | NEMOSHOW_TRANSFORM_STATE },
		...
		{ "tilemode",					NEMOSHOW_INTEGER_PROP,			NEMOSHOW_SHADER_DIRTY,			0x0 },
		{ "tilemode-x",				NEMOSHOW_INTEGER_PROP,			NEMOSHOW_SHADER_DIRTY,			0x0 },
		{ "tilemode-y",				NEMOSHOW_INTEGER_PROP,			NEMOSHOW_SHADER_DIRTY,			0x0 },
