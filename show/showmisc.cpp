...
struct showprop *nemoshow_get_property(const char *name)
{
	static struct showprop props[] = {
		...
		{ "cx",								NEMOSHOW_DOUBLE_PROP,				NEMOSHOW_SHAPE_DIRTY,				0x0 },
		{ "cy",								NEMOSHOW_DOUBLE_PROP,				NEMOSHOW_SHAPE_DIRTY,				0x0 },
		...
		{ "octaves",					NEMOSHOW_INTEGER_PROP,			NEMOSHOW_SHADER_DIRTY,			0x0 },
		...
		{ "pathdashes",				NEMOSHOW_DOUBLE_PROP,				NEMOSHOW_PATHEFFECT_DIRTY,	0x0 },
		{ "pathdashcount",		NEMOSHOW_INTEGER_PROP,			NEMOSHOW_PATHEFFECT_DIRTY,	0x0 },
		{ "pathdeviation",		NEMOSHOW_DOUBLE_PROP,				NEMOSHOW_PATHEFFECT_DIRTY,	0x0 },
		{ "pathseed",					NEMOSHOW_INTEGER_PROP,			NEMOSHOW_PATHEFFECT_DIRTY,	0x0 },
		{ "pathsegment",			NEMOSHOW_DOUBLE_PROP,				NEMOSHOW_PATHEFFECT_DIRTY,	0x0 },
