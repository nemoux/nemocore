...
struct showprop *nemoshow_get_property(const char *name)
{
	static struct showprop props[] = {
		...
		{ "pathdashes0",			NEMOSHOW_DOUBLE_PROP,				NEMOSHOW_PATH_DIRTY },
		{ "pathdashes1",			NEMOSHOW_DOUBLE_PROP,				NEMOSHOW_PATH_DIRTY },
		{ "pathdashes2",			NEMOSHOW_DOUBLE_PROP,				NEMOSHOW_PATH_DIRTY },
		{ "pathdashes3",			NEMOSHOW_DOUBLE_PROP,				NEMOSHOW_PATH_DIRTY },
