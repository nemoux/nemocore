...
extern int nemoshow_poly_check_plane(struct showone *cone, struct showone *pone, struct showone *one, double x, double y, float *tx, float *ty);
extern float nemoshow_poly_check_one(struct showone *cone, struct showone *pone, struct showone *one, double x, double y);
