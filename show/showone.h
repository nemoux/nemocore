...
typedef enum {
	...
	NEMOSHOW_MATRIX_DIRTY = (1 << 4),
	NEMOSHOW_URI_DIRTY = (1 << 5),
	NEMOSHOW_ALL_DIRTY = NEMOSHOW_SHAPE_DIRTY | NEMOSHOW_STYLE_DIRTY | NEMOSHOW_CHILD_DIRTY | NEMOSHOW_TEXT_DIRTY | NEMOSHOW_MATRIX_DIRTY | NEMOSHOW_URI_DIRTY
} NemoShowDirtyType;
