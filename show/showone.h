...
typedef enum {
	...
	NEMOSHOW_CMDS_DIRTY = (1 << 13),
	NEMOSHOW_ALL_DIRTY = NEMOSHOW_SHAPE_DIRTY | NEMOSHOW_STYLE_DIRTY | NEMOSHOW_TEXT_DIRTY | NEMOSHOW_FONT_DIRTY | NEMOSHOW_PATH_DIRTY | NEMOSHOW_MATRIX_DIRTY | NEMOSHOW_FILTER_DIRTY | NEMOSHOW_SHADER_DIRTY | NEMOSHOW_URI_DIRTY | NEMOSHOW_CANVAS_DIRTY | NEMOSHOW_SIZE_DIRTY | NEMOSHOW_POINTS_DIRTY | NEMOSHOW_CMDS_DIRTY
} NemoShowDirtyType;
