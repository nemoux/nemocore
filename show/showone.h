...
typedef enum {
	...
	NEMOSHOW_URI_DIRTY = (1 << 6),
	NEMOSHOW_ALL_DIRTY = NEMOSHOW_SHAPE_DIRTY | NEMOSHOW_STYLE_DIRTY | NEMOSHOW_CHILD_DIRTY | NEMOSHOW_TEXT_DIRTY | NEMOSHOW_FONT_DIRTY | NEMOSHOW_MATRIX_DIRTY | NEMOSHOW_URI_DIRTY
} NemoShowDirtyType;
