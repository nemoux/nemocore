...
extern struct showtransition *nemoshow_transition_dispatch_easy(struct nemoshow *show, struct showone *one, struct showone *ease, uint32_t duration, uint32_t delay, uint32_t repeat, const char *attr, double v0, double v1);
