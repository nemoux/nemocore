...
#define NEMOSHOW_BOUNCE_IN_EASE						(nemoeases[NEMOEASE_BOUNCE_IN_TYPE])
#define NEMOSHOW_BOUNCE_OUT_EASE					(nemoeases[NEMOEASE_BOUNCE_OUT_TYPE])
#define NEMOSHOW_BOUNCE_INOUT_EASE				(nemoeases[NEMOEASE_BOUNCE_INOUT_TYPE])
