...
extern int nemoshow_item_check_one(struct showone *one, double x, double y);
extern struct showone *nemoshow_item_pick_one(struct showone *one, double x, double y);
