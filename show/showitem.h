...
typedef enum {
	...
	NEMOSHOW_POINTS_ITEM = 12,
	NEMOSHOW_POLYLINE_ITEM = 13,
	NEMOSHOW_POLYGON_ITEM = 14,
	NEMOSHOW_IMAGE_ITEM = 15,
	NEMOSHOW_SVG_ITEM = 16,
	NEMOSHOW_GROUP_ITEM = 17,
	NEMOSHOW_CONTAINER_ITEM = 18,
	NEMOSHOW_LAST_ITEM
} NemoShowItemType;
