...
typedef enum {
	...
	NEMOSHOW_PATHARRAY_ITEM = 9,
	NEMOSHOW_PATHGROUP_ITEM = 10,
	NEMOSHOW_POINTS_ITEM = 11,
	NEMOSHOW_POLYLINE_ITEM = 12,
	NEMOSHOW_POLYGON_ITEM = 13,
	NEMOSHOW_IMAGE_ITEM = 14,
	NEMOSHOW_SVG_ITEM = 15,
	NEMOSHOW_GROUP_ITEM = 16,
	NEMOSHOW_CONTAINER_ITEM = 17,
	NEMOSHOW_LAST_ITEM
} NemoShowItemType;
