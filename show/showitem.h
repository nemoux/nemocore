...
extern void nemoshow_item_above_one(struct showone *one, struct showone *above);
extern void nemoshow_item_below_one(struct showone *one, struct showone *below);
