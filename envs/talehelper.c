...
static void nemotale_dispatch_actor_touch_down(struct touchpoint *tp, struct nemocontent *content, uint32_t time, uint64_t touchid, float x, float y, float gx, float gy)
{
	struct nemoactor *actor = (struct nemoactor *)container_of(content, struct nemoactor, base);
	struct nemotale *tale = (struct nemotale *)actor->context;
...
static void nemotale_dispatch_actor_touch_motion(struct touchpoint *tp, struct nemocontent *content, uint32_t time, uint64_t touchid, float x, float y, float gx, float gy)
{
	struct nemoactor *actor = (struct nemoactor *)container_of(content, struct nemoactor, base);
	struct nemotale *tale = (struct nemotale *)actor->context;
...
static int nemotale_dispatch_actor_dispatch_resize(struct nemoactor *actor, int32_t width, int32_t height, int32_t fixed)
{
	return 0;
}
