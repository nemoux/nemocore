...
struct jsoniter {
	...
	struct json_object_iterator siter;
	struct json_object_iterator eiter;
};
...
extern int nemonote_iterator_valid(struct noteiter *iter);
...
extern int nemonote_json_iterator_valid(struct jsoniter *iter);
