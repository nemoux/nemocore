...
extern void nemotoyz_style_set_dash_effect(struct toyzstyle *style, int *dashes, int count);
...
extern void nemotoyz_path_svg(struct toyzpath *path, const char *url, float x, float y, float w, float h);
