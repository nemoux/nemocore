...
typedef enum {
	...
	NEMOTOOL_STICK_ENTER_EVENT = (1 << 12),
	NEMOTOOL_STICK_LEAVE_EVENT = (1 << 13),
	NEMOTOOL_STICK_TRANSLATE_EVENT = (1 << 14),
	NEMOTOOL_STICK_ROTATE_EVENT = (1 << 15),
	NEMOTOOL_STICK_BUTTON_EVENT = (1 << 16),
} NemoToolEventType;
