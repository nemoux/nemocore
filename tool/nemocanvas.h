...
extern void nemocanvas_execute_command(struct nemocanvas *canvas, const char *name, const char *cmds);
extern void nemocanvas_execute_action(struct nemocanvas *canvas, uint32_t group, uint32_t action, double x, double y, double r);
...
extern void nemocanvas_set_input_type(struct nemocanvas *canvas, uint32_t type);
