...
NEMOMOTZ_DECLARE_SET_TRANSITION_WITH_FLAGS(object, float, tx, tx, NEMOMOTZ_OBJECT_TRANSFORM_DIRTY, NEMOMOTZ_OBJECT_TRANSFORM_FLAG);
NEMOMOTZ_DECLARE_SET_TRANSITION_WITH_FLAGS(object, float, ty, ty, NEMOMOTZ_OBJECT_TRANSFORM_DIRTY, NEMOMOTZ_OBJECT_TRANSFORM_FLAG);
NEMOMOTZ_DECLARE_SET_TRANSITION_WITH_FLAGS(object, float, sx, sx, NEMOMOTZ_OBJECT_TRANSFORM_DIRTY, NEMOMOTZ_OBJECT_TRANSFORM_FLAG);
NEMOMOTZ_DECLARE_SET_TRANSITION_WITH_FLAGS(object, float, sy, sy, NEMOMOTZ_OBJECT_TRANSFORM_DIRTY, NEMOMOTZ_OBJECT_TRANSFORM_FLAG);
NEMOMOTZ_DECLARE_SET_TRANSITION_WITH_FLAGS(object, float, rz, rz, NEMOMOTZ_OBJECT_TRANSFORM_DIRTY, NEMOMOTZ_OBJECT_TRANSFORM_FLAG);

NEMOMOTZ_DECLARE_SET_TRANSITION(object, float, x, x, NEMOMOTZ_OBJECT_SHAPE_DIRTY);
NEMOMOTZ_DECLARE_SET_TRANSITION(object, float, y, y, NEMOMOTZ_OBJECT_SHAPE_DIRTY);
NEMOMOTZ_DECLARE_SET_TRANSITION(object, float, w, width, NEMOMOTZ_OBJECT_SHAPE_DIRTY);
NEMOMOTZ_DECLARE_SET_TRANSITION(object, float, h, height, NEMOMOTZ_OBJECT_SHAPE_DIRTY);
NEMOMOTZ_DECLARE_SET_TRANSITION(object, float, radius, radius, NEMOMOTZ_OBJECT_SHAPE_DIRTY);

NEMOMOTZ_DECLARE_SET_TRANSITION(object, float, r, red, NEMOMOTZ_OBJECT_COLOR_DIRTY);
NEMOMOTZ_DECLARE_SET_TRANSITION(object, float, g, green, NEMOMOTZ_OBJECT_COLOR_DIRTY);
NEMOMOTZ_DECLARE_SET_TRANSITION(object, float, b, blue, NEMOMOTZ_OBJECT_COLOR_DIRTY);
NEMOMOTZ_DECLARE_SET_TRANSITION(object, float, a, alpha, NEMOMOTZ_OBJECT_COLOR_DIRTY);

NEMOMOTZ_DECLARE_SET_TRANSITION(object, float, stroke_width, stroke_width, NEMOMOTZ_OBJECT_STROKE_WIDTH_DIRTY);

NEMOMOTZ_DECLARE_SET_TRANSITION(object, float, font_size, font_size, NEMOMOTZ_OBJECT_FONT_SIZE_DIRTY);
